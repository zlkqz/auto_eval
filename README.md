...
[**Paper**](https://arxiv.org/abs/2407.10999) 
...
- But the contents of `openai_azure_api/` would give away the organization I belong to, so I omitted it. <mark><u>**!!!You must implement your API calling method by yourself.!!!**</u></mark>
